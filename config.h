...
static const struct xkb_rule_names xkb_rules = {
	...
	*/
	.layout = "us,ara",
	.options = "grp:sclk_toggle,ctrl:swapcaps",
};
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_e,           spawn,            SHCMD("emacsclient --alternate-editor= --create-frame") },
	...
	{ 0,                                   XKB_KEY_Print,       spawn,            SHCMD("screenshot full save") },
	{ MODKEY,                              XKB_KEY_Print,       spawn,            SHCMD("screenshot full copy") },
	{ WLR_MODIFIER_ALT,                    XKB_KEY_Sys_Req,     spawn,            SHCMD("screenshot full annotate") },
	{ WLR_MODIFIER_SHIFT,                  XKB_KEY_Print,       spawn,            SHCMD("screenshot monitor save") },
	{ MODKEY|WLR_MODIFIER_SHIFT,           XKB_KEY_Print,       spawn,            SHCMD("screenshot monitor copy") },
	{ WLR_MODIFIER_ALT|WLR_MODIFIER_SHIFT, XKB_KEY_Sys_Req,     spawn,            SHCMD("screenshot monitor annotate") },
	{ WLR_MODIFIER_CTRL,                   XKB_KEY_Print,       spawn,            SHCMD("screenshot region save") },
	{ MODKEY|WLR_MODIFIER_CTRL,            XKB_KEY_Print,       spawn,            SHCMD("screenshot region copy") },
	{ WLR_MODIFIER_ALT|WLR_MODIFIER_CTRL,  XKB_KEY_Sys_Req,     spawn,            SHCMD("screenshot region annotate") },

	{ MODKEY,                              XKB_KEY_bracketright, spawn,           SHCMD("ocr") },

	{ MODKEY,                    XKB_KEY_bracketleft, spawn,            SHCMD("clipboard-history text") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_braceleft,   spawn,            SHCMD("clipboard-history image") },

	{ MODKEY,                    XKB_KEY_Escape,      spawn,            SHCMD("power-menu") },
	{ MODKEY,                    XKB_KEY_equal,       spawn,            {.v = (const char*[]){ "hyprpicker", "-a", NULL } } },
